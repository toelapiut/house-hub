...
// import mui from 'material-ui'; import AlarmIcon from
// 'react-material-icons/icons/action/alarm';
          ...
          <ul className="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="pages/widgets.html">
                ...
                <span className="dash-title">Properties</span>
                <span className="pull-right-container">
            ...
            <li className="treeview">
              <a href="#">
                ...
                <span className="dash-title">Tenants</span>
                <span className="pull-right-container">
